...
public class Config {
  ...
  public static final Coding DEFAULT_ENCOUNTER_PARTICIPANT_TYPE_CODE = 
      new Coding("http://hl7.org/fhir/v3/ParticipationType", "PART", "Participation");
  public static final EncounterStatus DEFAULT_ENCOUNTER_STATUS = EncounterStatus.FINISHED;
  public static final Coding DEFAULT_DIAGNOSTICREPORT_PERFORMER_DATA_ABSENT_REASON_CODE = 
      new Coding("http://hl7.org/fhir/data-absent-reason", "unknown", "Unknown");
  public static final boolean DEFAULT_IMMUNIZATION_REPORTED = false;

  public static final String VALIDATION_DEFINITION_PATH = 
      "src/main/resources/validation-min.xml.zip";
  // in milliseconds, > 0
  public static final int DEFAULT_VALIDATOR_TERMINOLOGY_SERVER_CHECK_TIMEOUT = 10000; 
  ...
  public static final String NARRATIVE_PROPERTIES_FILE_PATH = 
      "file:src/main/resources/narrative/customnarrative.properties";
